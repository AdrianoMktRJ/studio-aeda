              ...
              <div key={index} className="text-center scroll-reveal" style={{ animationDelay: `${index * 100}ms` }}>
                <div className="mb-6 relative group">
                  <img 
                    src={step.image} 
                    alt={step.title} 
                    className="w-full h-48 object-cover rounded-xl shadow-lg aeda-image"
                  />
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover-lift scroll-reveal" style={{ animationDelay: `${index * 100}ms` }}>
