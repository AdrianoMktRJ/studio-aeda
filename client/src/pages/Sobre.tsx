    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          {/* Citação em destaque */}
          <div className="max-w-3xl mx-auto bg-white rounded-xl p-8 shadow-sm border-l-4 border-[#2D5F5D]">
            <div className="flex items-start gap-4">
              <span className="text-6xl text-[#2D5F5D] leading-none">"</span>
            ...
            {values.map((value, index) => (
              ...
              >
                <div className="w-12 h-12 bg-teal-50 rounded-lg flex items-center justify-center mb-4">
                  <value.icon className="w-6 h-6 text-[#2D5F5D]" />
                </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#2D5F5D] font-semibold px-10 py-7 text-lg rounded-lg transition-all"
              asChild
            >
